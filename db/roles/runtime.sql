...
GRANT SELECT, INSERT, UPDATE ON transaction_templates TO :"runtime_role";
...
GRANT USAGE, SELECT ON SEQUENCE
    ...
    categories_id_seq,
    transactions_id_seq,
    transaction_templates_id_seq,
    refresh_sessions_id_seq,
    refresh_session_families_seq,
    admin_access_events_id_seq
TO :"runtime_role";

REVOKE DELETE, TRUNCATE ON users, categories, transactions, transaction_templates FROM :"runtime_role";
