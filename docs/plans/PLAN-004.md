...
1. Petakan setiap route finance admin dari api.md.
2. Definisikan DTO, ejaan isDelete, role, serta scope actor/owner.
3. Definisikan delete/restore berbasis versi, detail Trash, dan laporan aktif saja.
4. Definisikan create/profile/role/delete/restore akun admin dan daftar audit.
5. Validasi contoh, keamanan route, cakupan method, dan kode hasil generate.
...
Boolean wajib dan string/null invalid; override owner/role/lifecycle; mutasi admin; versi hilang/lama; compile/drift.
