...
1. Finalisasi preset tanggal dan bucket minggu/bulan parsial.
2. Gunakan agregasi income/expense/difference dan kategori hanya untuk is_delete=false.
3. Pastikan delete/restore mengubah total tepat satu kali dan histori kategori tetap.
4. Gunakan zona waktu target admin tanpa agregat lintas owner.
5. Uji rentang kalender, leap date, batas inklusif, dan laporan kosong.
...
Batas minggu/bulan/tahun; delete/restore; kategori historis; A/B/admin; zona waktu; empty/benchmark.
