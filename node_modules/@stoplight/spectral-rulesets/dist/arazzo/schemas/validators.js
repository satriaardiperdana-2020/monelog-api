...
function tr(e, { instancePath: t = "", parentData: a, parentDataProperty: r, rootData: s = e, dynamicAnchors: n = {} } = {}) { let o = null, i = 0; const p = tr.evaluated; if (p.dynamicProps && (p.props = void 0), p.dynamicItems && (p.items = void 0), pa(e, { instancePath: t, parentData: a, parentDataProperty: r, rootData: s, dynamicAnchors: n }))
    var c = pa.evaluated.props;
else
    o = null === o ? pa.errors : o.concat(pa.errors), i = o.length; const l = i, m = i; if (e && "object" == typeof e && !Array.isArray(e)) {
    let t;
    ...
    i = l, null !== o && (l ? o.length = l : o = null); if (e && "object" == typeof e && !Array.isArray(e)) {
    if (!0 !== c && ((c = c || {}).summary = !0, c.description = !0, c.value = !0, c.externalValue = !0), void 0 !== e.summary && "string" != typeof e.summary) {
        const e = { instancePath: t + "/summary", schemaPath: "#/properties/summary/type", keyword: "type", params: { type: "string" }, message: "must be string" };
        null === o ? o = [e] : o.push(e), i++;
    }
    if (void 0 !== e.description && "string" != typeof e.description) {
