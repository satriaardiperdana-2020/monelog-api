...
class Ruleset {
    constructor(maybeDefinition, context) {
        ...
        if ((0, json_1.isPlainObject)(maybeDefinition) && 'extends' in maybeDefinition) {
            ...
            (0, index_1.assertValidRuleset)({ extends: [], ...def }, 'js', context === null || context === void 0 ? void 0 : context.sourceContext);
            definition = maybeDefinition;
        }
        else {
            (0, index_1.assertValidRuleset)(maybeDefinition, 'js', context === null || context === void 0 ? void 0 : context.sourceContext);
            definition = maybeDefinition;
        }
